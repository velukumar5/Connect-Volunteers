...
var employeee = require ('./controllers/employeee.js');
var logout = require ('./controllers/logout');
var verify = require ('./controllers/verify');
var store = require ('./controllers/store');
var storee = require ('./controllers/storee');
var landing = require ('./controllers/landing');
var about = require ('./controllers/about');
var complain = require ('./controllers/complain');
var inbox = require ('./controllers/inbox');
var appointment = require ('./controllers/appointment');
var appointmentt = require ('./controllers/appointmentt');
...
app.use ('/appointmentt',appointmentt);
