...
describe("ETHDaddy", () => {
  ...
  beforeEach(async () => {
    ...
    ethDaddy = await ETHDaddy.deploy('NAME','SYMBOL')//EDITED

    //List a Domain
    const transaction = await ethDaddy.connect(deployer).list("TamilNadu", tokens(10))
  ...
  describe ("Domain", () => {
    it("Returns domain attributes", async () => {
      ...
      expect(domain.name).to.be.equal("TamilNadu")
