  ...
  return (
    <div>
      ...
      <div className='cards__section'>
        <h2 className='cards__title'>Why do we Donate for Disaster.</h2>
        <p className='cards__description'>
        We deliver help to anyone who needs it. Your gift to "Disaster Relief" enables us to provide food, 
        shelter, relief supplies, emotional support, recovery planning and other assistance during disasters.
        </p>
